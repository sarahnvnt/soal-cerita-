...
void traversal(Queue Q){
  	...
  	if(Q.Head == NULL){
	 	...
	 	cout<<"Antrian Permintaan A : ";
        while(pBantu != NULL){
            if(pBantu->info.perm=='A'||pBantu->info.perm=='a'){
                cout << pBantu->info.nama<<"["<< pBantu->info.no<<"]"<<"->";
            }
            pBantu = pBantu->next;
        }
    cout << endl<<endl;
    ...
    pBantu=Q.Head;
    cout<<"Antrian Permintaan B : ";
    while(pBantu != NULL){
        if(pBantu->info.perm=='B'||pBantu->info.perm=='b'){
            cout << pBantu->info.nama<<"["<< pBantu->info.no<<"]"<<"->";
        }
    pBantu = pBantu->next;
 }
    cout << endl<<endl;
   	cout<<"No.Antrian\tNama\t\tJenis Permintaan"<<endl;
   	pBantu=Q.Head;
   	while(pBantu != NULL){
   		cout<<pBantu->info.no<<"\t\t"<<pBantu->info.nama<<"\t\t"<<pBantu->info.perm<<"\t\t\t"<<endl;
     	pBantu = pBantu->next;
   }
   	cout<<endl;
}
